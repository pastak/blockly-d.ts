...
declare module Blockly {
    ...
    class BlockSvg__Class extends Blockly.Block__Class  { 
             ...
             */
            setBorderColour_(rgb: string, colourTertiary: string): void;
             ...
             */
            setShadowColour_(rgb: string, colourSecondary: string): string;
...
declare module Blockly {
    ...
    class Field__Class  { 
             ...
             * @constructor
             */
            constructor(text: string, opt_validator?: { (_0: string): string|any /*null*/|any /*undefined*/ });
             ...
             */
            setValidator(handler: { (_0: string): string|any /*null*/|any /*undefined*/ }): void;
...
declare module Blockly {
    ...
    class FieldImage__Class extends Blockly.Field__Class  { 
             ...
             * @constructor
             */
            constructor(src: string, width: number, height: number, opt_alt?: string, opt_onClick?: Function, opt_flipRtl?: boolean);
...
declare module Blockly {
    ...
    class Theme__Class  { 
             ...
             * @constructor
             */
            constructor(blockStyles: { [key: string]: Blockly.BlockStyle }, categoryStyles: { [key: string]: Blockly.CategoryStyle });
             ...
             * block styles.
             */
            setAllBlockStyles(blockStyles: { [key: string]: Blockly.BlockStyle }): void;
    
            /**
             * Gets a list of all the block style names.
             * @return {Array.<String>} List of blockstyle names.
             */
            getAllBlockStyles(): String[];
             ...
             */
            getBlockStyle(blockStyleName: string): Blockly.BlockStyle;
            ...
            */
            setBlockStyle(blockStyleName: string, blockStyle: Blockly.BlockStyle): void;
             ...
             */
            getCategoryStyle(categoryStyleName: string): Blockly.CategoryStyle;
            ...
            */
            setCategoryStyle(categoryStyleName: string, categoryStyle: Blockly.CategoryStyle): void;
    } 
...
declare module Blockly.utils {
     ...
     * @package
     */
    function clampNumber(lowerBound: number, number: number, upperBound: number): number;
}
...
declare module Blockly.Xml.utils {
     ...
     * @package
     */
    function textToDomDocument(text: string): Element;
